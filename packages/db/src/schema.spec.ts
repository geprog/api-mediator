...
describe("pg enum ↔ domain parity", () => {
  const cases: ReadonlyArray<[string, readonly string[], readonly string[]]> = [
    ...
    ["aggregation_strategy", aggregationStrategyEnum.enumValues, aggregationStrategySchema.options],
    ["endpoint_strictness", endpointStrictnessEnum.enumValues, endpointStrictnessSchema.options],
    [
      "adapter_write_outcome_status",
      adapterWriteOutcomeStatusEnum.enumValues,
      adapterWriteOutcomeStatusSchema.options,
    ],
    [
      "adapter_request_cause",
      adapterRequestCauseEnum.enumValues,
      adapterRequestCauseSchema.options,
    ],
